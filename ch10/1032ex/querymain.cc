...
void print_results(const vector<TextQuery::line_no>& locs,         // 改为vector
                   const string& sought, const TextQuery &file)
{
    // if the word was found, then print count and all occurrences
    typedef vector<TextQuery::line_no> line_nums;    // 改为vector
...
int main(int argc, char **argv)
{
    ...
    while (true) {
        ...
        vector<TextQuery::line_no> locs = tq.run_query(s);   //改为vector
